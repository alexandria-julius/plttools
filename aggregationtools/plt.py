...
class PLT:
    ...
    def get_variance(self):
        """ Retrieves the Variance for the losses of the annual losses for the PLT
            Parameters for RM
            ----------
            ...
            -------
            float :
                The variance of the annual losses for the PLT
        """
    ...
    def get_covvar(self):
        ...
        covvar = self.get_standard_deviation() / mean
        return covvar
